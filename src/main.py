...
def main():
    ...
    parser.add_argument("--center", action="store_true", default=True, help="是否將圖片置中於原點 (預設開啟)")
    ...
    parser.add_argument("--invert", action="store_true", help="執行圖片反相 (將白色部分視為實心)")
    parser.add_argument("--hatch", type=float, default=0.0, help="區域填充線間距 (mm)，0 代表不填充")
